...
class ceph::profile::base {
  ...
  class { '::ceph':
    ...
    bluestore_compression_mode         => $ceph::profile::params::bluestore_compression_mode,
    bluestore_compression_algorithm    => $ceph::profile::params::bluestore_compression_algorithm,
    rbd_cache                          => $ceph::profile::params::rbd_cache,
    rbd_cache_writethrough_until_flush => $ceph::profile::params::rbd_cache_writethrough_until_flush,
    rbd_concurrent_management_ops      => $ceph::profile::params::rbd_concurrent_management_ops,
  }
}
